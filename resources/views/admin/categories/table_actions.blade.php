<a class="btn btn-sm btn-primary" href="{{ route('categories.edit', $row->id) }}"><i class="align-middle"
        data-feather="edit"></i></a>
<form class="d-inline" action="{{ route('categories.destroy', $row->id) }}" method="POST"
